...
class HealthStateTest extends Specification {
    ...
    def createStateFromChecks(Map<String, HealthCheckID> checks) {
        ...
        return new HealthStateV1(wrappedChecks)
    }

    def sendCheckResult(HealthStateV1 health, HealthCheckID id, HealthStateEnum state,
        ...
        health.updateStateV1(wrapper, expirationPeriod)
    }
